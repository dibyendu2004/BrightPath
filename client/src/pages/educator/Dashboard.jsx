    ...
    <div className='min-h-screen flex flex-col items-start justify-start gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      ...
      <div className='w-full'>
        ...
        <div className='flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border border-gray-500/20'>
          <table className='table-fixed md:table-auto w-full text-gray-500 shrink-0'>
              ...
              {dashboardData.enrolledStudentsData.slice(0, 5).map((item, index) => (
                <tr key={index} className='border-b border-gray-500/20'>
                  ...
                  <td className='md:px-4 px-2 py-3 flex items-center space-x-3'>
                    <img src={item.studentImage || assets.profile_img} alt="profile" className='w-9 h-9 rounded-full' />
